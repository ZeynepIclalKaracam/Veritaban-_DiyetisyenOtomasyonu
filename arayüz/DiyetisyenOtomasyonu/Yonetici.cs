...
namespace DiyetisyenOtomasyonu
{
    public partial class Yonetici : Form
    {
        ...
        private void viewBTN_Click(object sender, EventArgs e)
        {
            try
            {
                SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM vw_UyeBilgileri", baglan);
            ...
            {
                MessageBox.Show("View verisi getirilemedi: " + ex.Message);
            }
        }
        ...
        private void triggerBTN_Click(object sender, EventArgs e)
        {
            try
            {
                SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM KiloUyariLog", baglan);
                DataTable dt = new DataTable();
                da.Fill(dt);
                dataGridView1.DataSource = dt;
            }
            ...
            {
                MessageBox.Show("Log verisi getirilemedi: " + ex.Message);
            }
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            try
            {
                int minYas = Convert.ToInt32(txtMinYas.Text.Trim());
                int maxYas = Convert.ToInt32(txtMaxYas.Text.Trim());

                SqlCommand komut = new SqlCommand("sp_YasGrubunaGoreUyeListele", baglan);
                komut.CommandType = CommandType.StoredProcedure;
                komut.Parameters.AddWithValue("@MinYas", minYas);
                komut.Parameters.AddWithValue("@MaxYas", maxYas);
            ...
            {
                MessageBox.Show("Yaş aralığına göre veri getirilemedi: " + ex.Message);
            }
        }
    } 
}
